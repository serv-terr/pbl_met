...
!   MODOS.f90 - V0.0.02
!
!   This is a Fortran 90 module, supporting the basic read-and-decode
!   of MODOS-formatted data files.
!
!   Created on Tue Mar  2 07:03:25 2004
!
!   Warning to the reader: this code utilizes Fortran 95 syntax features
!                          extensively, with a special emphasis on
!   modular and programming-in-the-large features. 
!
