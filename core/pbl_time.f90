...
module pbl_time
	...
	! Internal constants
	real(8), parameter	:: TIME_MIN = 0.0d0
	real(8), parameter	:: TIME_MAX = 253402300800.0d0	! Smallest Epoch value corresponding to an illegal date (10000-01-01 00:00:00.000)
